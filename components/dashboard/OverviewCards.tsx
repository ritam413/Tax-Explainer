...
export const OverviewCards: React.FC<OverviewCardsProps> = ({ dataset }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
      ...
      <div className="bg-[#181818] rounded-[8px] border border-[#485346] p-5 shadow-md hover:border-[#7fee64]/50 transition-all">
        ...
        <div className="font-manrope font-semibold text-[24px] text-[#ddffdc]">
          {currency}{total.toFixed(2)} Lakh Cr
        </div>
        <p className="text-[12px] text-[#8cab87] mt-1">100% of fiscal budget</p>
      </div>
      ...
      <div className="bg-[#181818] rounded-[8px] border border-[#485346] p-5 shadow-md hover:border-[#7fee64]/50 transition-all">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="p-2 rounded-[6px] bg-[#212525] text-[#ffa130]">
            <Award className="w-4 h-4" />
          </div>
        </div>
        <div className="font-manrope font-semibold text-[20px] text-[#ddffdc] truncate">
          {topSector ? topSector.category.split('&')[0] : 'Interest Payments'}
        </div>
        <p className="text-[12px] text-[#7fee64] font-semibold mt-1">
      ...
      <div className="bg-[#181818] rounded-[8px] border border-[#485346] p-5 shadow-md hover:border-[#7fee64]/50 transition-all">
        ...
        <p className="text-[12px] text-[#8cab87] mt-1">Compared to FY 2025</p>
      </div>
      ...
      <div className="bg-[#181818] rounded-[8px] border border-[#485346] p-5 shadow-md hover:border-[#7fee64]/50 transition-all">
        ...
        <p className="text-[12px] text-[#8cab87] mt-1">Parsed & sanitized</p>
      </div>
    </div>
  );
};
